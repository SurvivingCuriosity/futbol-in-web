    ...
    <section id="descargar" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="relative rounded-3xl overflow-hidden">
          {/* Background */}
          <div className="absolute inset-0 bg-linear-to-br from-accent/20 via-accent/10 to-transparent" />
          ...
          <div className="relative z-10 px-8 md:px-16 py-18 md:py-28">
            <div className="max-w-3xl mx-auto text-center space-y-8">
              ...
              <p className="text-xl text-muted-foreground text-pretty">
                Únete a la comunidad más grande de jugadores de futbolín.
                Descarga la app gratis y encuentra tu próxima partida.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                ...
                <button className="rounded-xl border-accent/30 hover:bg-accent/10 text-lg px-8 h-14 bg-transparent">
                  Ver Demo
                </button>
              </div>
